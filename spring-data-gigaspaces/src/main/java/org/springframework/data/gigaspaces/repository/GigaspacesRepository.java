...
/**
 * <p>Gigaspaces specific {@link org.springframework.data.repository.Repository} interface. Contains features from
 * {@link org.springframework.data.repository.CrudRepository} and
 * {@link org.springframework.data.repository.PagingAndSortingRepository}. Is also supplied with Gigaspaces features: take
 * methods, Change and Projection APIs.</p>
 * <p>Use this interface as a base for you Gigaspaces Repositories.</p>
 * <p>Example:</p>
 * <blockquote><pre>
 ...
 */
@NoRepositoryBean
public interface GigaspacesRepository<T, ID extends Serializable> extends PagingAndSortingRepository<T, ID> {

    /**
     * Provides access to GigaSpaces Gigaspaces native API.
     *
