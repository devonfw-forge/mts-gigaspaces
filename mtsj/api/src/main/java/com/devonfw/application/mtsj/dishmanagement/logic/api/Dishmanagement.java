...
public interface Dishmanagement {
   ...
   */
  CategoryEto findCategory(String id);
  ...
  /**
   * Returns a Dish by its id.
   *
   * @param id The id of the Dish.
   * @return The Composite Transport Object with id.
   */
  DishCto findDish(String id);
   ...
   */
  IngredientEto findIngredient(String id);
