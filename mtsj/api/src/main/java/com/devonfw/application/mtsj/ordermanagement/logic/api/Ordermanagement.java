...
public interface Ordermanagement {
   ...
   */
  List<OrderCto> findOrdersByInvitedGuest(String invitedGuestId);
   ...
   * @return the list {@link OrderCto}
   */
  List<OrderCto> findOrders(String idBooking);
   ...
   */
  OrderLineEto findOrderLine(String id);
   ...
   */
  boolean deleteOrderLine(String orderLineId);
