...
public interface DishmanagementRestService {
  ...
  @GET
  @Path("/category/{id}/")
  public CategoryEto getCategory(@PathParam("id") String id);
  ...
  @GET
  @Path("/dish/{id}/")
  public DishCto getDish(@PathParam("id") String id);
  ...
  @GET
  @Path("/ingredient/{id}/")
  public IngredientEto getIngredient(@PathParam("id") String id);
