...
public interface Bookingmanagement {
   ...
   */
  BookingCto findBooking(String id);
   ...
   */
  List<InvitedGuestEto> findInvitedGuestByBooking(String bookingId);
   ...
   */
  InvitedGuestEto findInvitedGuest(String id);
   ...
   */
  boolean deleteInvitedGuest(String invitedGuestId);
