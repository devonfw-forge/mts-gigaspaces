...
public interface BookingmanagementRestService {
  ...
  @GET
  @Path("/booking/{id}/")
  public BookingCto getBooking(@PathParam("id") String id);
  ...
  public InvitedGuestEto getInvitedGuest(@PathParam("id") String id);
  ...
  @DELETE
  @Path("/invitedguest/{id}/")
  public void deleteInvitedGuest(@PathParam("id") String id);
  ...
  @DELETE
  @Path("/table/{id}/")
  public void deleteTable(@PathParam("id") String id);
